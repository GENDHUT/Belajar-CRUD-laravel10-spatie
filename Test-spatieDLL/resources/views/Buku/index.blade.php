                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="py-2 px-4">
                                    @if ($item->gambar)
                                        <img src="{{ asset('storage/gambar_buku/' . $item->gambar) }}" alt="Gambar {{ $item->judul }}" class="w-20 h-20 object-cover">
                                    @else
                                        <img src="{{ asset('images/default-placeholder.png') }}" alt="Placeholder" class="w-20 h-20 object-cover">
                                    @endif
                                </td>
