                                ...
                                <tr class="border border-gray-300 dark:border-gray-600">
                                    ...
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('user.edit', $user) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white px-4 py-2 rounded">
                                                Edit
                                            </a>
                                            <form action="{{ route('user.destroy', $user) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');">
                                                @csrf
                                                @method('DELETE')
